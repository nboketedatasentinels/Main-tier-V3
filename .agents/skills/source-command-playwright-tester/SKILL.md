---
name: "source-command-playwright-tester"
...
# source-command-playwright-tester

Use this skill when the user asks to run the migrated source command `playwright-tester`.
