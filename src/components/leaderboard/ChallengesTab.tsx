        ...
        <Flex justify="space-between" align="center" mb={4}>
          <Box>
            ...
            <Text fontSize="sm" color="gray.600" mt={1} maxW="640px">
              An individual 7-day 1v1 challenge. Only the winner earns Challenger checklist points.
              We count points you gain during the challenge — not your lifetime total. Accepting
              alone does not award points. Someone already in a challenge cannot be selected again
              until that challenge ends.
            </Text>
          </Box>
          <Button
