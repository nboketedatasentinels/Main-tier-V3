...
export const SupportTeamCard = ({ data, loading }: SupportTeamCardProps) => {
  return (
    <Card h="100%" variant="outline" borderColor="brand.border">
      <CardBody>
        <Stack spacing={4}>
          <Text fontWeight="bold" color="#5A6ACF">Support Team</Text>
                ...
                <HStack spacing={3} w="100%" justify="space-between">
                  <HStack spacing={2}>
                    ...
                    <VStack spacing={0} align="start">
                      <Text fontWeight="semibold" color="#5A6ACF">Mentor</Text>
              ...
              <VStack align="start" spacing={2} p={3} borderWidth="1px" borderColor="brand.border" rounded="md">
                <HStack spacing={3} w="100%" justify="space-between">
                  <HStack spacing={2}>
                    ...
                    <VStack spacing={0} align="start">
                      <Text fontWeight="semibold" color="#5A6ACF">Ambassador</Text>
                      <Text fontSize="sm" color="#5A6ACF">
