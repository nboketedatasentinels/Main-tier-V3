...
const helpContent: Record<AdvancementHelpVariant, string> = {
  week_unlock:
    'Weeks unlock when you complete milestones, not automatically over time. Earn at least 67% of your current cycle target and complete any pending partner approvals to advance to the next week.',
  ...
  points_threshold:
    'You need to earn at least 67% of your cycle target points to be eligible for week advancement. This ensures consistent engagement while allowing flexibility in your learning approach.'
}
