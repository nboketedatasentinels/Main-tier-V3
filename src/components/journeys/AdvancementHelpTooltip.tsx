...
const helpContent: Record<AdvancementHelpVariant, string> = {
  week_unlock:
    'Weeks unlock when you complete milestones, not automatically over time. Earn at least 67% of your weekly target points and complete any pending partner approvals to advance to the next week.',

  window_concept:
    'Windows are 2-week periods used to track your progress consistently. Your advancement is measured across windows to ensure balanced engagement throughout your journey.',
  ...
  points_threshold:
    'You need to earn at least 67% of your weekly target points to be eligible for week advancement. This ensures consistent engagement while allowing flexibility in your learning approach.'
}
