...
const DOT_MAP_ROUTES: { start: RoutePoint; end: RoutePoint; color: string }[] = [
...
export function T4LAuthShell({ children }: { children: React.ReactNode }) {
  return (
    ...
    >
      ...
      >
        <div className="hidden md:block w-1/2 h-[640px] relative overflow-hidden border-r border-gray-100">
