...
/**
 * Shared course-completion approval flow. Lives inside the partner's Issue
 * Activities page so partners can issue partner-issued activities and approve
 * course completions in the same place. Courses shown are the ones linked to
 * the selected organization's program (which carries the journey + pillar).
 */
export const CourseApprovalsSection: React.FC = () => {
  ...
  const handleApprove = useCallback(
    ...
    [completionLookup, profile, selectedLearner, selectedOrgId, toast],
  )
