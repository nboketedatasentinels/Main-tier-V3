...
const WEEK_1_TEMPLATES: ProgrammeNotificationTemplate[] = [
 ...
 messageBody: `One week in, {{firstName}}. How is it going? Complete your pre-course assessment in the app - honest answers, no wrong ones.`,
 externalUrl: '/app/assessments/course?kind=pre',
 targetAudience: TARGET_AUDIENCE,
 isActive: true,
 },
]
...
const WEEK_4_TEMPLATES: ProgrammeNotificationTemplate[] = [
 ...
 messageBody: `You made it, {{firstName}}. One last step - complete your post-course assessment in the app. Your honest feedback shapes the next cohort.`,
 externalUrl: '/app/assessments/course?kind=post',
 targetAudience: TARGET_AUDIENCE,
 isActive: true,
 },
]
