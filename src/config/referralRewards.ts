...
export const REWARD_TIERS: RewardTier[] = [
  ...
  {
    id: 3,
    title: "25% Off 'AI for Transformation Leader' Course",
    required: 15,
    reward: "25% Off 'AI for Transformation Leader'",
    description: 'Enjoy an exclusive 25% discount on the flagship AI for Transformation Leader course.',
    label: 'Course',
    icon: Layers,
