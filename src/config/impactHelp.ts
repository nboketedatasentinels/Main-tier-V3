...
export const IMPACT_HELP: Record<
  ImpactHelpKey,
  { t: string; p: string; eg: string; vid: string }
> = {
  baseline: {
  ...
  lock: {
    ...
    vid: 'Locking and versioning a baseline',
  },
  tier: {
  ...
  annual: {
    ...
    vid: 'Per period versus run rate',
  },
  waste: {
    t: 'Why the 8 wastes',
  ...
  journey: {
    ...
    vid: 'Following a claim through approval',
  },
  rates: {
  ...
  rules: {
    ...
    vid: 'The seven aggregation rules',
  },
  howvalued: {
