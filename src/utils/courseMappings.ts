...
export const COURSE_DETAILS_MAPPING: Record<string, CourseDetail> = {
  ...
  'AI for Transformation Leader: Judgment Over Features': {
  ...
  'Stakeholder Influence for Transformation Leader': {
...
export const COURSE_METADATA_MAPPING: Record<string, CourseMetadata> = {
  ...
  'AI for Transformation Leader: Judgment Over Features': { estimatedMinutes: 90, difficulty: 'Advanced' },
  'Hire Me Already: The Confidence-Boosting Job Search Blueprint': { estimatedMinutes: 80, difficulty: 'Intermediate' },
  'Stakeholder Influence for Transformation Leader': { estimatedMinutes: 75, difficulty: 'Beginner' },
...
const COURSE_TITLE_ALIASES: Record<string, string> = {
  ...
  'AI Stacking 101: Boost Your Productivity (No Tech Skills Needed)': 'AI for Transformation Leader: Judgment Over Features',
  'The Art of Connection: Sharpening Communication, Feedback, and Presentation Skills': 'Stakeholder Influence for Transformation Leader',
  ...
  // Brand rename: Transformation Leaders → Transformation Leader
  'AI for Transformation Leaders: Judgment Over Features': 'AI for Transformation Leader: Judgment Over Features',
  'Stakeholder Influence for Transformation Leaders': 'Stakeholder Influence for Transformation Leader',
  'AI Operating Hour for Transformation Leaders': 'AI Operating Hour for Transformation Leader',
