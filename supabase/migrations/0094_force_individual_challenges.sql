-- ============================================================================
-- Challenges are individual (competitive) only — collaborative retired.
-- ============================================================================

alter table public.challenges
  alter column type set default 'competitive';
...
begin
  ...
  -- Collaborative is retired; always create individual competitive challenges.
  v_type := 'competitive';
